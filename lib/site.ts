...
export const services: Service[] = [
  ...
  },
  {
    ...
    navLabel: "Prep & Repair",
    short: "Prep & Repair",
    category: "System",
    promise: "The unglamorous step that decides whether a floor lasts or fails.",
    headline: "Concrete prep and repair done right, because coatings are only as good as the slab.",
    intro:
      "Every great floor starts below the coating. We diamond grind to the correct profile, chase and fill cracks, patch spalls and pits, address moisture, and remove old failed coatings or flooring. When you hear a horror story about epoxy peeling, it almost always traces back to skipped prep. We never skip it.",
    problem:
      "A buddy or a box-store kit went down without real prep, and now it is peeling, bubbling, or flaking off.",
    benefits: [
      ...
      { title: "Old coating removal", body: "We strip and grind off failed epoxy, paint, glue, and tile so we can start from solid concrete." },
    ...
    idealFor: ["Failed DIY or box-store epoxy", "Cracked or pitted slabs", "Old tile, glue, or carpet removal", "Damp basements and garages"],
    outcome:
    ...
    keywords: ["concrete floor prep", "epoxy removal", "concrete crack repair", "concrete grinding michigan", "floor demolition"],
